...
iyvsaur = ImageTk.PhotoImage(Image.open("iyvasour.jpg"))
...
pokemon_list = [abra, bulbasaur, charmander, iyvsaur, jigglypuff, kadabra, meowth, nidoking, paras, persion, pikachu, ratata, squirtle]
